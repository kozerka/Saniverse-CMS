        ...
        <section className="relative pt-52 pb-40 max-lg:pt-52 max-lg:pb-36 max-md:pt-36 max-md:pb-32">
            <Element name="hero">
                <div className="container">
                    <div className="relative z-2 max-w-612 max-lg:max-w-488 flex justify-between items-center">
                        <div>
                            ...
                            <p className="max-w-640 mb-14 body-1 max-md:mb-10">
                                Create your own blog for free. Add more users
                                for only $9/month. Welcome to Saniverse — your
                                personalized blogging space.
                            </p>
                            <LinkScroll
                                to="features"
                                spy
